...
function Paint(){
    ...
    Paint.prototype.filter = function(sketch, filter){
        ...
        }else{tempElementsClass = tempElementsTag;}
        ...
        }else{tempElementsId = tempElementsClass;}
    ...
    Paint.prototype.brush = function(sketch, brush){
        ...
        for(let i = 0; i < sketch.length; i++){
            ...
            if(brush.color !== null){ sketch[i].style.color= brush.color;}

            if(brush.fontFamily !== null){ sketch[i].style.fontFamily= brush.fontFamily;}

            if(brush.fontWeight !== null){ sketch[i].style.fontWeight= brush.fontWeight;}

            //-----------------

            if(brush.cursor !== null){ sketch[i].style.cursor= brush.cursor;}

            //-----------------

            if(brush.margin !== null){ sketch[i].style.margin= brush.margin;}

            if(brush.padding!==null){ sketch[i].style.padding=brush.padding;}
            ...
            if(brush.background !== null){ sketch[i].style.background = brush.background;}

            if(brush.backgroundColor !== null){ sketch[i].style.backgroundColor = brush.backgroundColor;}

            if(brush.backgroundImage !== null){ sketch[i].style.backgroundImage = brush.backgroundImage;}

            if(brush.backgroundPosition !== null){ sketch[i].style.backgroundPosition = brush.backgroundPosition;}

            if(brush.backgroundSize !== null){ sketch[i].style.backgroundSize = brush.backgroundSize;}

            if(brush.backgroundRepeat !== null){ sketch[i].style.backgroundRepeat = brush.backgroundRepeat;}

            //-----------------

            if(brush.opacity !== null){ sketch[i].style.opacity = brush.opacity;}

            //-----------------

            if(brush.width !== null){ sketch[i].style.width = brush.width;}

            if(brush.height !== null){ sketch[i].style.height = brush.height;}

            //-----------------

            if(brush.display !== null){ sketch[i].style.display = brush.display}
