function Player(){
    ...
    Player.prototype.set = function(type, value, strict = false){
        ...
        if(type == 'hearts'){
            ...
            if(strict == false){   this.hearts += value; }
            else if (strict == true){   this.hearts = value; }
            ...
            if(strict == false){   this.stars += value; }
            else if (strict == true){   this.stars = value; }
            ...
            if(strict == false){   this.money += parseInt(value); }
            else if (strict == true){   this.money = value; }
            ...
            if(this.hand.length >= this.handLimit){ render.animate.hand(context, 'fail', game.state.player.hand, render.scene.memory.hand, 200, 0, true);
                return; }
