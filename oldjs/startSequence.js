...
function cicleUpdate() {
  ...
  if (
    render.print.checkMemory("hearts", game.state.render.print.hearts) == false
  ) {
    render.print.hearts(game.state.render.print.hearts);
  }

  if (
    render.print.checkMemory("stars", game.state.render.print.stars) == false
  ) {
    render.print.stars(game.state.render.print.stars);
  }

  if (
    render.print.checkMemory("money", game.state.render.print.money) == false
  ) {
